                ...
                <div class="hei_513">
                    <div class="info">
                        <span class="left_name">
                            <span class="m_func">Shopping Cart</span>
                        </span>
                    </div>
                    <div style="margin-left:5%"><br><br>                        
                        <table>
                            ...
                            $_SESSION['aid'] = $pAddress['id'];
                            
                            //get primary payment
                            $card = new CreditCard();
                            $pCard = $card->getPC($_SESSION['row']['email']);
                            $_SESSION['cid'] = $pCard['id'];
                        ...
                        <br><br>
                        <button class="u-btn2 j-buy" type="button" style="background-color:orange; color:white"><a href="WebApp.php" class="button"><strong>Continue Shopping</strong></a></button>
                        <button class="u-btn2 j-buy" type="button"><a href="CheckOut.php" class="button"  style="color:white"><strong>Checkout</strong></a></button>
